...
MONITOR_TIMEOUT_SECONDS="${MONITOR_TIMEOUT_SECONDS:-20}"
MONITOR_TIMEOUT_SECONDS_ON_DETECTION="${MONITOR_TIMEOUT_SECONDS_ON_DETECTION:-20}"

case "$MONITOR_TIMEOUT_SECONDS" in
    ''|*[!0-9]*) MONITOR_TIMEOUT_SECONDS=20 ;;
esac
case "$MONITOR_TIMEOUT_SECONDS_ON_DETECTION" in
    ''|*[!0-9]*) MONITOR_TIMEOUT_SECONDS_ON_DETECTION=20 ;;
esac
