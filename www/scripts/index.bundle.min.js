(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    (function () {
      ...
      var mimeCandidates = ["audio/webm;codecs=opus", "audio/webm;codecs=pcm", "audio/webm"];
      if (typeof MediaRecorder.isTypeSupported === "function") {
        for (var i = 0; i < mimeCandidates.length; i += 1) {
          if (MediaRecorder.isTypeSupported(mimeCandidates[i])) {
            preferredMimeType = mimeCandidates[i];
            break;
          }
        }
      } else {
      ...
      if (!preferredMimeType) {
        ...
        if (mimeLbl) { mimeLbl.textContent = "PTT format unsupported"; }
        pttBtn.disabled = true;
        return;
      }
        ...
        navigator.mediaDevices.getUserMedia({ audio: true, video: false })
          .then(function (stream) {
            ...
            try {
              ...
              console.log("PTT start error: " + startErr.message);
              mediaRecorder = null;
              pttActive = false;
              releaseStream();
              flashAndReset("Start failed", "ptt-error", 1800);
              return;
            }
      ...
      function stopRecording(fromMaxDuration) {
        ...
        var recorderRef = mediaRecorder;
        var chunkRef = audioChunks.slice(0);
        mediaRecorder = null;
        audioChunks = [];

        recorderRef.addEventListener("stop", function () {
          releaseStream();
          ...
          var blobType = recorderRef.mimeType || preferredMimeType || "audio/webm";
          var blob = new Blob(chunkRef, { type: blobType });
          if (!blob || blob.size <= 0) {
          ...
          var uploadMime = blob.type || "application/octet-stream";
          var requestOptions = {
            method: "POST",
          ...
          fetch("cgi-bin/upload_audio.cgi", requestOptions)
            ...
            .then(function (result) {
              ...
              } else if (result.payload === "CONVERSION_FAILED") {
        ...
        try {
          ...
          releaseStream();
          flashAndReset("Stop failed", "ptt-error", 1500);
        }
      }
