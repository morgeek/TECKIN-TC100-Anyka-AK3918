(function () {
  ...
  function updateSysUsageBadges(sysusageText, cpuPercentHint, ramPercentHint) {
    ...
    var homeCpu = byId("home_cpu");
    var homeRam = byId("home_ram");
    if (homeCpu) homeCpu.textContent = typeof cpu === "number" ? cpu + "%" : "--%";
    if (homeRam) homeRam.textContent = typeof ramPercent === "number" ? ramPercent + "%" : "--%";
  ...
  function updateSdUsageBadge(sdPercent) {
    ...
    var homeSd = byId("home_sd");
    if (homeSd) homeSd.textContent = Math.min(sdPercent, 100) + "%";
